...
hadoop jar /usr/hdp/current/hadoop-mapreduce-client/hadoop-streaming.jar -file /home/hdfs/mapper1.py -mapper /home/hdfs/mapper1.py -file /home/hdfs/reducer1.py -reducer /home/hdfs/reducer1.py -input /user/jxu/data.csv -output /user/jxu/all_accidents
